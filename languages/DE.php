...
$public_stat = array("öffentlich", "privat", "eingeloggt");
...
$CALTEXT['CUSTOM_SELECT_WBLINK'] = "Seite auswählen";
$CALTEXT['RESIZE_IMAGES'] = "Bildgröße ändern";
$CALTEXT['SUPPORT_INFO'] = "Hinweise zum Modul";
$CALTEXT['SUPPORT_INFO_INTRO'] = "Bitte lies vor Verwendung des Moduls die ";
$CALTEXT['FORMAT_ACTION'] = "Mit dem Ballsymbol können Sie eine Farbe für die Kategorie festlegen";
$CALTEXT['FORMAT_DAY'] = "Diese Farbe im Kalender benutzen?";
$CALTEXT['MAKE_REC'] = "Wiederholender Termin?";
$CALTEXT['DAILY'] = "täglich";
$CALTEXT['WEEKLY'] = "wöchentlich";
$CALTEXT['MONTHLY'] = "monatlich";
$CALTEXT['YEARLY'] = "jährlich";
$CALTEXT['DAYS'] = "Tage";
$CALTEXT['DAY'] = "Tag";
$CALTEXT['EVERY'] = "Jeden";
...
$CALTEXT['ISREC_MESSAGE'] = "Dieser Termin ist Teil einer Terminserie. \n&quot;OK&quot; - um die ganze Serie zu ändern. \n&quot;Abbrechen&quot; - um den Termin zu überschreiben oder einen neuen Termin anzulegen.";
$CALTEXT['REC_OVERWRITE_MESSAGE'] = "Dieser Termin überschreibt eine Terminserie. \nWenn Sie diesen Termin löschen, wird der ursprüngliche Termin der Serie wieder aktiv.";
$CALTEXT['REC_OVERWRITE'] = "Überschreiben";
