...
<div class="field_line rec_exceptions procal_hidden">
    <div class="field_title" ><?php echo $CALTEXT['NOT_AT']; ?></div>
    <span><input name="date_exclude1" id="date_exclude1" class="date-pick" <?php echo $rec_date_exclude1; ?>/></span>
    <span>&nbsp;&nbsp;<input name="date_exclude2" id="date_exclude2" class="date-pick" <?php echo $rec_date_exclude2; ?>/></span>
    <span>&nbsp;&nbsp;<input name="date_exclude3" id="date_exclude3" class="date-pick" <?php echo $rec_date_exclude3; ?>/></span>
</div>
